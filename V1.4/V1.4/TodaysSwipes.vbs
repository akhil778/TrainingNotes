...
coumnNoForTime = 5
LakshmanRekhaArray = Array("Tripod","Flap Barrier","Basement Door","Floor Canteen","TRIPOD TO PARKING")
...
'IE.Navigate "http://cybagemis/Framework/Iframe.aspx" 
'waitToLoad IE

'IE.Document.GetElementById("MTt95").click
'waitToLoad IE

IE.Navigate "http://cybagemis/Report Builder/RPTN/ReportPage.aspx" 
waitToLoad IE
...
Function calculateWEEKLY
	...
	IE.Navigate "http://cybagemis/Core/Common/Introduction.aspx" 
	WScript.sleep 200
	waitToLoad IE
